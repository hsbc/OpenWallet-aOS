...
import com.openwallet.constants.PARAMS_CHANGE_PASSWORD_PHONE
import com.openwallet.constants.PARAMS_CHANGE_PASSWORD_PHONE_COUNTRY_CODE
...
class ChangePasswordPhoneSmsFragment : BasePhoneSmsFragment() {
    private lateinit var phone: String
    private lateinit var phoneCountryCode: String

    override fun getParameters() {
        arguments?.let {
            phone = it.getString(PARAMS_CHANGE_PASSWORD_PHONE).orEmpty()
            phoneCountryCode = it.getString(PARAMS_CHANGE_PASSWORD_PHONE_COUNTRY_CODE).orEmpty()
        }
    }
    ...
    override fun navigate() {
        nav().navigate(
            R.id.action_ChangePasswordPhoneSmsFragment_to_ChangePasswordConfirmationFragment, null,
            NavOptions.Builder().setPopUpTo(R.id.changePasswordPhoneSms, true).build()
        )
    }
}